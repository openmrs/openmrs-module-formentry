...
<xsl:stylesheet version="1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:openmrs="http://schema.yoursite.org/FormEntry/1" xmlns:my="http://schemas.microsoft.com/office/infopath/2003/myXSD/2006-07-25T11:22:21" xmlns:ns1="/moduleServlet/formentry/forms/schema/4-1" xmlns:xd="http://schemas.microsoft.com/office/infopath/2003" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns:xdExtension="http://schemas.microsoft.com/office/infopath/2003/xslt/extension" xmlns:xdXDocument="http://schemas.microsoft.com/office/infopath/2003/xslt/xDocument" xmlns:xdSolution="http://schemas.microsoft.com/office/infopath/2003/xslt/solution" xmlns:xdFormatting="http://schemas.microsoft.com/office/infopath/2003/xslt/formatting" xmlns:xdImage="http://schemas.microsoft.com/office/infopath/2003/xslt/xImage" xmlns:xdUtil="http://schemas.microsoft.com/office/infopath/2003/xslt/Util" xmlns:xdMath="http://schemas.microsoft.com/office/infopath/2003/xslt/Math" xmlns:xdDate="http://schemas.microsoft.com/office/infopath/2003/xslt/Date" xmlns:sig="http://www.w3.org/2000/09/xmldsig#" xmlns:xdSignatureProperties="http://schemas.microsoft.com/office/infopath/2003/SignatureProperties" xmlns:ipApp="http://schemas.microsoft.com/office/infopath/2006/XPathExtension/ipApp" xmlns:xdEnvironment="http://schemas.microsoft.com/office/infopath/2006/xslt/environment" xmlns:xdUser="http://schemas.microsoft.com/office/infopath/2006/xslt/User">
...
.optionalPlaceholder {
	PADDING-RIGHT: 20px
			...
			<body>
								...
								<td colSpan="2" style="BORDER-RIGHT: #000000 1pt solid; PADDING-RIGHT: 1px; BORDER-TOP: #000000 1pt solid; PADDING-LEFT: 1px; PADDING-BOTTOM: 1px; VERTICAL-ALIGN: middle; BORDER-LEFT: #000000 1pt solid; PADDING-TOP: 1px; BORDER-BOTTOM: #000000 1pt solid; BACKGROUND-COLOR: #c0c0c0">
									<div align="center">
										<font face="Arial" size="3">
											<strong>Unit Testing Form</strong>
										</font>
									</div>
								</td>
						...
						<tbody vAlign="top">
							<tr style="MIN-HEIGHT: 57px">
								...
								<td rowSpan="2" style="BORDER-RIGHT: #000000 1pt solid; PADDING-RIGHT: 5px; BORDER-TOP: #000000 1pt solid; PADDING-LEFT: 5px; PADDING-BOTTOM: 5px; BORDER-LEFT: #000000 1pt; PADDING-TOP: 5px; BORDER-BOTTOM: #000000 1pt solid">
									<font size="2">
										<font face="Arial">
											<div><span class="xdTextBox" hideFocus="1" title="" xd:CtrlId="CTRL46" xd:xctname="PlainText" tabIndex="-1" xd:binding="patient/patient_address.address1" xd:disableEditing="yes" style="FONT-WEIGHT: bold; FONT-SIZE: small; WIDTH: 179px; COLOR: #000000; FONT-STYLE: normal; FONT-FAMILY: Arial; WHITE-SPACE: nowrap; TEXT-ALIGN: center; TEXT-DECORATION: none; WORD-WRAP: normal">
													<xsl:value-of select="patient/patient_address.address1"/>
												</span>
											</div>
											<div><span class="xdTextBox" hideFocus="1" title="" xd:CtrlId="CTRL47" xd:xctname="PlainText" tabIndex="-1" xd:binding="patient/patient_address.address2" xd:disableEditing="yes" style="FONT-WEIGHT: bold; FONT-SIZE: small; WIDTH: 179px; COLOR: #000000; FONT-STYLE: normal; FONT-FAMILY: Arial; WHITE-SPACE: nowrap; TEXT-ALIGN: center; TEXT-DECORATION: none; WORD-WRAP: normal">
								...
								<td rowSpan="2" style="BORDER-RIGHT: #000000 1pt solid; PADDING-RIGHT: 5px; BORDER-TOP: #000000 1pt solid; PADDING-LEFT: 5px; PADDING-BOTTOM: 5px; BORDER-LEFT: #000000 1pt solid; PADDING-TOP: 5px; BORDER-BOTTOM: #000000 1pt solid">
									<font size="2">
										<font face="Arial">
											<div>Location: </div>
											<div>
												<div><input class="xdBehavior_Boolean" title="" type="radio" name="{generate-id(encounter/encounter.location_id)}" xd:CtrlId="CTRL17" xd:xctname="OptionButton" tabIndex="0" xd:boundProp="xd:value" xd:binding="encounter/encounter.location_id" xd:onValue="1^Unknown">
							...
							<tr style="MIN-HEIGHT: 36px">
								<td style="BORDER-RIGHT: #000000 1pt solid; PADDING-RIGHT: 5px; BORDER-TOP: #000000 1pt solid; PADDING-LEFT: 5px; PADDING-BOTTOM: 5px; VERTICAL-ALIGN: middle; BORDER-LEFT: #000000 1pt solid; PADDING-TOP: 5px; BORDER-BOTTOM: #000000 1pt solid">
									<div>
										<font face="Arial" size="2">Gender:  <span class="xdExpressionBox xdDataBindingUI" title="" xd:CtrlId="CTRL19" xd:xctname="ExpressionBox" tabIndex="-1" xd:disableEditing="yes" style="FONT-WEIGHT: bold; WIDTH: 43px">
										...
										<table class="xdRepeatingTable msoUcTable" title="" style="TABLE-LAYOUT: fixed; WIDTH: 367px; BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-COLLAPSE: collapse; WORD-WRAP: break-word; BORDER-BOTTOM-STYLE: none" border="1" xd:CtrlId="CTRL37">
											...
											<tbody class="xdTableHeader">
												...
												<xsl:for-each select="problem_list/problem_added">
													<tr>
														<td><span class="xdExpressionBox xdDataBindingUI" title="" xd:CtrlId="CTRL44" xd:xctname="ExpressionBox" xd:binding="concat(position(), &quot;.&quot;)" style="FONT-WEIGHT: bold; FONT-SIZE: small; WIDTH: 24px; FONT-FAMILY: Arial; WHITE-SPACE: normal; TEXT-ALIGN: center">
																<xsl:value-of select="concat(position(), &quot;.&quot;)"/>
															</span><span class="xdExpressionBox xdDataBindingUI" title="" xd:CtrlId="CTRL45" xd:xctname="ExpressionBox" xd:binding="substring-before(substring-after(., &quot;^&quot;), &quot;^&quot;)" style="OVERFLOW-Y: hidden; FONT-SIZE: small; WIDTH: 286px; FONT-FAMILY: Arial; WHITE-SPACE: nowrap; HEIGHT: 24px; WORD-WRAP: normal">
																<xsl:value-of select="substring-before(substring-after(., &quot;^&quot;), &quot;^&quot;)"/>
															</span><input class="langFont" title="" style="FONT-SIZE: xx-small; FONT-FAMILY: Arial" type="button" value="Delete" xd:CtrlId="DeleteNewProblem" xd:xctname="Button"/>
														</td>
													</tr>
												</xsl:for-each>
											</tbody>
										...
										<table class="xdRepeatingTable msoUcTable" title="" style="TABLE-LAYOUT: fixed; WIDTH: 361px; BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-COLLAPSE: collapse; WORD-WRAP: break-word; BORDER-BOTTOM-STYLE: none" border="1" xd:CtrlId="CTRL49">
											...
											<tbody class="xdTableHeader">
												...
												<xsl:for-each select="problem_list/problem_resolved">
													<tr>
														<td><span class="xdExpressionBox xdDataBindingUI" title="" xd:CtrlId="CTRL56" xd:xctname="ExpressionBox" xd:binding="concat(position(), &quot;.&quot;)" style="FONT-WEIGHT: bold; FONT-SIZE: small; WIDTH: 24px; FONT-FAMILY: Arial; WHITE-SPACE: normal; TEXT-ALIGN: center">
																<xsl:value-of select="concat(position(), &quot;.&quot;)"/>
															</span><span class="xdExpressionBox xdDataBindingUI" title="" xd:CtrlId="CTRL57" xd:xctname="ExpressionBox" xd:binding="substring-before(substring-after(., &quot;^&quot;), &quot;^&quot;)" style="OVERFLOW-Y: hidden; FONT-SIZE: small; WIDTH: 276px; FONT-FAMILY: Arial; WHITE-SPACE: nowrap; HEIGHT: 22px; WORD-WRAP: normal">
																<xsl:value-of select="substring-before(substring-after(., &quot;^&quot;), &quot;^&quot;)"/>
															</span><input class="langFont" title="" style="FONT-SIZE: xx-small; FONT-FAMILY: Arial" type="button" value="Delete" xd:CtrlId="DeleteResolvedProblem" xd:xctname="Button"/>
														</td>
													</tr>
												</xsl:for-each>
											</tbody>
				...
				<div>
					<input class="xdBehavior_Boolean" title="" type="radio" name="{generate-id(obs/actual_treatment/current_antitb_holder/tb_schema/value)}" xd:xctname="OptionButton" xd:CtrlId="CTRL1895" tabIndex="0" xd:binding="obs/actual_treatment/current_antitb_holder/tb_schema/value" xd:boundProp="xd:value" xd:onValue="2124^2RHZ / 4RH^99DCT">
						<xsl:attribute name="xd:value">
							<xsl:value-of select="obs/actual_treatment/current_antitb_holder/tb_schema/value"/>
						</xsl:attribute>
						<xsl:if test="obs/actual_treatment/current_antitb_holder/tb_schema/value=&quot;2124^2RHZ / 4RH^99DCT&quot;">
							<xsl:attribute name="CHECKED">CHECKED</xsl:attribute>
						</xsl:if>
					</input>Premier: 2RHZ / 4RH
				</div>
				<div align="left"> </div>
